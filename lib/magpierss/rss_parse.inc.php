...
* File:        rss_parse.inc.php  - parse an RSS or Atom feed
...
require_once (MAGPIE_DIR . 'rss_utils.inc.php');

/**
* Hybrid parser, and object, takes RSS as a string and returns a simple object.
*
* see: rss_fetch.inc.php for a simpler interface with integrated caching support
*
*/
class MagpieRSS {
    var $parser;
